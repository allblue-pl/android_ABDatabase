...
public class ABDatabase_Backup
{
    ...
    public ABDatabase_Backup(final Context context)
    {
        this.lock = new ReentrantLock();
        this.lock.lock();

        if (ABDatabase_Backup.DatabaseHelperInstance == null)
            ABDatabase_Backup.DatabaseHelperInstance = new DatabaseHelper(context);
        this.db = ABDatabase_Backup.DatabaseHelperInstance.getWritableDatabase();
